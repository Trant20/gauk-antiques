...
const ulanCount = (c.match(new RegExp(ulanBlock.replace(/[.*+?^${}()|[\]\\]/g, String.raw`\$&`), 'g')) || []).length
...
const portraitCount = (c.match(new RegExp(largePortrait.replace(/[.*+?^${}()|[\]\\]/g, String.raw`\$&`), 'g')) || []).length
